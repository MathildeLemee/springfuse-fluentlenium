...
public class FlowsMenuHandler implements Serializable {
    ...
    private List<FlowMenuEntry> flowMenuEntries = new ArrayList<FlowMenuEntry>();
    ...
    public boolean isFlowAlreadyOpen(RequestContext context, Identifiable<?> entity) {
        ...
        for (FlowMenuEntry fme : getFlowMenuEntries(flowId)) {
            if (fme.getEntityId() != null && entity.getPrimaryKey() != null
                    && fme.getEntityId().equals(entity.getPrimaryKey())) {
                return true;
            }
        }
    ...
    private List<FlowMenuEntry> getFlowMenuEntries() {
        List<FlowMenuEntry> result = new ArrayList<FlowMenuEntry>();
        for (FlowMenuEntry fme : flowMenuEntries) {
            if (fme.isLabelSet()) {
                result.add(fme);
            }
    ...
    private List<FlowMenuEntry> getFlowMenuEntries(String flowId) {
        List<FlowMenuEntry> result = new ArrayList<FlowMenuEntry>();
        for (FlowMenuEntry fme : flowMenuEntries) {
